    ...
    datasets: [
      {
        ...
        pointBackgroundColor: 'rgb(238, 188, 29)',
        pointBorderColor: 'rgb(238, 188, 29)',
        pointHoverBackgroundColor: 'rgb(238, 188, 29)',
        pointHoverBorderColor: 'rgb(238, 188, 29)',
      },
    ],
    labels: [],
  };
  ...
  getGraphData(days: number) {
    ...
    this.api
      ...
      .subscribe((res) => {
        ...
        (this.lineChartData.datasets[0].label = `Price ( Past ${this.days} Days ) in ${this.currency}`),
